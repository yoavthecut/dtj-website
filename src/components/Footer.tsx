...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/destined_to_be_a_jew/",
    icon: (
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@DestinedToBeAJew",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@destined_to_be_jew?lang=en",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "WhatsApp",
    href: "https://chat.whatsapp.com/HPhHBNdkzE5Fq4lg4Xe809",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  return (
    <footer className="bg-brand-purple text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-purple-700 text-center text-xs text-white/65">
          © {new Date().getFullYear()} Destined to be a Jew. All rights reserved.
        </div>
      </div>
    </footer>
  );
